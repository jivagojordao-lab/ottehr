...
import { ERX_TASK, FAX_TASK, MANUAL_TASK, RADIOLOGY_TASK } from 'utils/lib/types/data/tasks/types';
...
export const TASK_CATEGORY_LABEL: Record<string, string> = {
  [LAB_ORDER_TASK.category]: 'Laboratório Externo',
  [IN_HOUSE_LAB_TASK.category]: 'Laboratório Interno',
  [RADIOLOGY_TASK.category]: 'Radiologia',
  [ERX_TASK.category]: 'Receita Digital (eRX)',
  [MANUAL_TASK.category.externalLab]: 'Laboratório Externo',
  [MANUAL_TASK.category.inHouseLab]: 'Laboratório Interno',
  [MANUAL_TASK.category.inHouseMedications]: 'Medicamentos Internos',
  [MANUAL_TASK.category.nursingOrders]: 'Prescrições de Enfermagem',
  [MANUAL_TASK.category.patientFollowUp]: 'Acompanhamento do Paciente',
  [MANUAL_TASK.category.procedures]: 'Procedimentos',
  [MANUAL_TASK.category.radiology]: 'Radiologia',
  [MANUAL_TASK.category.erx]: 'Receita Digital (eRX)',
  [MANUAL_TASK.category.charting]: 'Evolução / Prontuário',
  [MANUAL_TASK.category.coding]: 'Codificação',
  [MANUAL_TASK.category.billing]: 'Faturamento',
  [FAX_TASK.category]: 'Fax / Envio de Documentos',
  [MANUAL_TASK.category.other]: 'Outro',
};
